      ...
      <div className={styles.page}>
              ...
              <div key={suggestProduct.id} className={`card ${styles.margin}`}>
                <div className={'card-content'}>
                  <div className={'media-content'}>
                    <p className={`title ${styles.paddin}`}>
                      {suggestProduct.name}
                    </p>
                    <p className={`subtitle ${styles.paddin}`}>
                      {suggestProduct.price}円
                    </p>
                  </div>
                  <div className={`content ${styles.paddin}`}>
                    {suggestProduct.explanation}
                  </div>

                  <footer className={styles.cfooter}>
                    <button
                      className={`button ${styles.citem}`}
                      onClick={() => {
                        minusOrder(
                          suggestProduct.id,
                          currentQuantity,
        ...
        <div className={styles.fix}>
          <div className={styles.order}>
            <span className={`has-text-weight-bold ${styles.sumprice}`}>
              合計料金: {totalPrice()}円(税込)
            </span>
            <button
              className={`button`}
              onClick={handleClick}
